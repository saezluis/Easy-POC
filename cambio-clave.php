...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
      <h3>Mi perfil / Cambio de clave</h3>
    </div>
	...
	<div id="campana" class="grupo">
		...
		*/
		echo "<form method=\"POST\" action=\"procesar-cambio-clave.php\">";
		
			echo "<input type=\"text\" class=\"nolineBox\" value=\"Clave anterior: \"><input type=\"password\" name=\"clave_anterior\" required>";
			echo "<br>";
			echo "<br>";
			echo "<input type=\"text\" class=\"nolineBox\" value=\"Nueva clave: \"><input type=\"password\" name=\"nueva_clave\" required>";
			echo "<br>";
			echo "<br>";
			echo "<input type=\"text\" class=\"nolineBox\" value=\"Repita la nueva clave: \"><input type=\"password\" name=\"nueva_clave_repita\" required>";
			echo "<br>";
			echo "<br>";
			echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
			<input type=\"submit\" value=\"Cambiar\"> &nbsp;&nbsp; <a href=\"mi-perfil.php\"><input type=\"button\" value=\"Cancelar\"></a>";
		echo "</form>";
		?>	
		</div>  
	</div>
