  ...
  <body>
	...
	*/
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h4>Gestionar Campañas</h4>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
          <li><a href="consultar-campana.php" class="consultar">Consultar</a></li>
          <li><a href="agregar-campana.php" class="agregar">Agregar</a></li>		  
          <li><a href="modificar-campana-principal.php" class="modificar">Modificar</a></li>
          <li><a href="eliminar-campana-select.php" class="eliminar">Eliminar</a></li>		 
        </ul>
      </div>
    </section>
