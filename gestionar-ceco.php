  ...
  <body>
	...
	*/
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h4>Gestionar Centro de Costo</h4>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
          <li><a href="consultar-ceco.php" class="consultar">Consultar</a></li>
          <li><a href="agregar-ceco.php" class="agregar">Agregar</a></li>		  
          <li><a href="modificar-ceco-principal.php" class="modificar">Modificar</a></li>
          <li><a href="eliminar-ceco-select.php" class="eliminar">Eliminar</a></li>		 
        </ul>
      </div>
    </section>
