...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
      <h3>Administrador</h3>
	  <h4>Eliminar Campañas</h4>
	  <h6><a href="gestionar-campanas.php">Volver</a></h6>
	  <h6>Seleccione id de la campaaña que desea eliminar.</h6>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosCampana)){
					...
					echo "<tr>";
						echo "<td class=\"area\"><a href=\"eliminar-campana.php?id_camp_s=",urlencode($id_campana)," \">$id_campana</a></td>";
