  ...
  <body>
	...
	*/
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h4>Gestionar Control Presupuesto</h4>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
          <li><a href="consultar-control.php" class="consultar">Consultar</a></li>
          <li><a href="agregar-control.php" class="agregar">Agregar</a></li>		  
          <li><a href="modificar-control-principal.php" class="modificar">Modificar</a></li>
          <li><a href="eliminar-control-select.php" class="eliminar">Eliminar</a></li>
        </ul>
      </div>
    </section>
