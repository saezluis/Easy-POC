  ...
  <body>
	...
	*/
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h4>Gestionar Registro Gasto</h4>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
          <li><a href="consultar-registro.php" class="consultar">Consultar</a></li>
          <li><a href="agregar-registro.php" class="agregar">Agregar</a></li>
          <li><a href="modificar-registro-principal.php" class="modificar">Modificar</a></li>
          <li><a href="eliminar-registro-select.php" class="eliminar">Eliminar</a></li>
        </ul>
      </div>
    </section>
