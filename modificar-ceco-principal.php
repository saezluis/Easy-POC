...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h6>Seleccione ID del Centro de Costo que desea modificar.</h6>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
    ...
    <section class="grupo">
      <table class="table-sap" style="width: 50% !important;">
        <thead>
          <tr class="cabecc-sap" >
			<th>ID Codigo CECO</th>
			<th>Codigo SAP</th>
            <th>Descripción</th>
            <th>CECO</th>            
          </tr>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosCeco)){
					...
					$codigo_ceco = $reg['id_centro_costo'];
					...
					echo "<tr>";
						echo "<td><a href=\"modificar-ceco.php?id_ceco_s=",urlencode($codigo_ceco)," \">$codigo_ceco</a></td>";
						echo "<td>$codigo_sap</td>";
