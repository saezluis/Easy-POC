...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h6>Seleccione ID del control presupuesto que desea modificar.</h6>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosControl)){
					...
					echo "<tr>";
						echo "<td class=\"area\"><a href=\"modificar-control.php?id_control_s=",urlencode($id_controlP)," \">$id_controlP</a></td>";
