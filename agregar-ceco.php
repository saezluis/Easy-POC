...
<html lang="es">
  ...
  <body>	
	...
	<!--
	  ...
	  -->
		<form method="POST" action="procesar-agregar-ceco.php" class="add">
			<label>Codigo SAP</label>
			<input name="codigo_sap" type="text" required>
			<label>Descripción</label>
			<input name="descripcion" type="text" required>
			<label>CECO</label>
			<input name="ceco" type="text" required>
			<br><br>
			<input type="submit" value="Agregar">			
		</form>
		<br>
		<form method="POST">
			<input type="submit" value="Cancelar" formaction="gestionar-ceco.php">
		</form>
    </section>
