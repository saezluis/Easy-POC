...
<html lang="es">
  ...
  <body>
    ...
    <section class="grupo">
      <div class="nav-admin">
        <ul>
          <li><a href="consultar-proveedor.php" class="consultar">Consultar</a></li>
          <li><a href="agregar-proveedor.php" class="agregar">Agregar</a></li>		  
          <li><a href="modificar-proveedor-principal.php" class="modificar">Modificar</a></li>
          <li><a href="eliminar-proveedor-select.php" class="eliminar">Eliminar</a></li>		 
        </ul>
      </div>
    </section>
