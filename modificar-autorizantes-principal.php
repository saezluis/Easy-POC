...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h6>Seleccione ID del autorizante que desea modificar.</h6>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosAuto)){
					...
					echo "<tr>";
						echo "<td class=\"area\"><a href=\"modificar-autorizante.php?id_auto_s=",urlencode($id_autorizante)," \">$id_autorizante</a></td>";
