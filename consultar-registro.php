  ...
  <body>
	...
	*/
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h4>Consultar Registro Gasto</h4>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosGasto)){
					...
					echo "<tr>";
						echo "<td class=\"\">$codigo_sap</td>";
						echo "<td class=\"\">$registro_gasto</td>";
						echo "<td class=\"\">$control_ppto</td>";
						echo "<td class=\"\">$articulo_sap</td>";
						echo "<td class=\"\">$cuenta_sap</td>";
					echo "</tr>";
				}				
			?>
        </tbody>
