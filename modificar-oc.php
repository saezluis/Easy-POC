...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h6>Seleccione orden de compra que desea modificar</h6>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosOrdenes)){
					...
					echo "<tr>";
						echo "<td class=\"area\"><a href=\"modificar-oc-detalle.php?oc_send=",urlencode($numero_orden),"  \">$numero_orden</a></td>";
