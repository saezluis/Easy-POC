...
<html lang="es">
  ...
  <body>	
	...
	<!--
	  ...
	  -->
		<form method="POST" action="procesar-agregar-campana.php" class="add">
			<label>Codigo SAP</label>
			<input name="codigo_sap" type="text" required>
			<label>Nombre campaña</label>
			<input name="nombre_campana" type="text" required>
			<br><br>
			<input type="submit" value="Agregar">			
		</form>
		<br>
		<form method="POST">
			<input type="submit" value="Cancelar" formaction="gestionar-campanas.php">
		</form>
    </section>
