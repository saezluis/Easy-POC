...
<html lang="es">
  ...
  <body>	
	...
	<!--
	  ...
	  -->
		<form method="POST" action="procesar-agregar-autorizantes.php" class="add">			
			<label>Nombre Autorizante</label>
			<input name="nombre_autorizante" type="text" required>
			<br><br>
			<input type="submit" value="Agregar">			
		</form>
		<br>
		<form method="POST">
			<input type="submit" value="Cancelar" formaction="gestionar-autorizantes.php">
		</form>
    </section>
