...
<html lang="es">
  ...
  <body>
    ...
    <div id="data--input" class="grupo">
	  ...
	  <h6>Seleccione ID del Registro Gasto que desea eliminar.</h6>
    </div>
    <section class="grupo">
      <div class="nav-admin">
        <ul>
        ...
        <tbody>
			<?php
				...
				while($reg=mysqli_fetch_array($registrosGasto)){
					...
					echo "<tr>";
						echo "<td class=\"area\"><a href=\"eliminar-registro.php?id_registro_s=",urlencode($id_registro)," \">$id_registro</a></td>";
						echo "<td class=\"ceco\">$id</td>";
						echo "<td class=\"desc-servicio\">$registro_gasto</td>";
						echo "<td class=\"desc-servicio\">$control_ppto</td>";
						echo "<td class=\"desc-servicio\">$articulo_sap</td>";
						echo "<td class=\"desc-servicio\">$cuenta_sap</td>";
					echo "</tr>";
				}
