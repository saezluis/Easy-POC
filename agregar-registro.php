...
<html lang="es">
  ...
  <body>	
	...
	<!--
	  ...
	  -->
		<form method="POST" action="procesar-agregar-registro.php" class="add">
			<label>Codigo SAP</label>
			<input name="codigo_sap" type="text" required>
			<label>Registro Gasto</label>
			<input name="registro_gasto" type="text" required>
			<label>Control Presupuesto</label>
			<input name="control_presupuesto" type="text" required>
			<label>Artículo SAP</label>
			<input name="articulo_sap" type="text" required>
			<label>Cuenta SAP</label>
			<input name="cuenta_sap" type="text" required>
			<br><br>
			<input type="submit" value="Agregar">			
		</form>
		<br>
		<form method="POST">
			<input type="submit" value="Cancelar" formaction="gestionar-registro.php">
		</form>
    </section>
